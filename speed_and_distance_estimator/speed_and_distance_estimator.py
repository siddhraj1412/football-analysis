...
class SpeedAndDistanceEstimator:
    def __init__(self):
        self.frame_window = 5
        self.frame_rate = 24  # Assuming 24 FPS
    
    def add_speed_and_distance_to_tracks(self, tracks):
        total_distance = {}
        
        for object, object_tracks in tracks.items():
            if object == "ball" or object == "referees":  # Changed "refree" to "referees"
                continue
                ...
                for track_id, _ in object_tracks[frame_num].items():
                    ...
                    for frame_num_batch in range(frame_num, last_frame):
                        if track_id not in object_tracks[frame_num_batch]:
                            continue
                        # Changed key names to match what draw_speed_and_distance expects
